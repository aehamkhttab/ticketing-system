                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('tickets.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="attachment" id="attachment" class="form-control @error('attachment') is-invalid @enderror" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.xlsx">
                                <small class="form-text text-muted">Allowed types: jpg, jpeg, png, pdf, doc, docx, xlsx.</small>
                                @error('attachment')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
